    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="index.php">
            <div class="">
            <img src="images/kos.jpg" width="70px" height="70px" alt="">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?menu=provil-kos">Provil Kos</a></li>
            <li><a href="?menu=cara-pesan">Cara Booking</a></li>
            <li><a href="?menu=login">Login</a></li>.
            <li><a href="?menu=registrasi">Registrasi Member</a></li>
