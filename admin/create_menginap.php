<?php
    include '../config/koneksi.php';
        $sql =  mysql_query("SELECT * FROM pesankamar WHERE kd_pesan='$_GET[kd]'");
	...
	<div class="box-body"  style="width:99.5%">
      ...
      <tr>
        <div class="form-group">
          ...
          <td><input type="text" class="form-control" name="tambahan_biaya" placeholder=""></td>
          </div>
      </tr>
        <td></td>
...
if (isset($_POST['submit'])) {
  ...
  include '../config/koneksi.php';
       mysql_query("INSERT INTO menginap VALUES
         ('','$kd_kamar','$id_pelanggan','$tgl_menginap','$jatuh_tempo','','$tambahan_biaya','$keterangan','1')");
         //pelanggan
