...
<section class="content">
  <div class="row">
          <a href="?menu=pilih-kos" style="color:#595757;float:right;">
        ...
        <div style="width:28%;margin:5px 15px 0 5px ;padding:0 30px 0 0;overflow:hidden">
            <font size="4px" style="float:left;padding:10px;">Data Pemesanan Kamar</font>
          </div>
    <div class="col-xs-12">
          ...
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            <?php
                $no=1;
                  ...
                  $sql=mysql_query("SELECT * FROM pesankamar WHERE stts !='0' AND id_pelanggan='$bc1[id_pelanggan]'");
              ...
              <tr>
                  ...
                  <td><?php echo $bc['tgl_pesan']." ".$bc['jam_pesan']; ?></td>
                  <td>
                      <?php
                        if ($bc['stts']==1) {
                          echo "Booking Kamar";
