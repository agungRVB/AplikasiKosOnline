<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
    <h1 class="box-title" style="font-size:150%;">Laporan Pelanggan Menginap</h1>
</div>
<!-- Main content -->
                  ...
                  <!--<td align="center">
                    <?php
                      if (empty($bc['tgl_keluar'])) {?>
                        ...
                        <a class="action" href="Keluar_kos.php?kd=<?php echo $bc['id_pelanggan'];?>" style="padding:2.3px 4px 2.3px 8px;" >
